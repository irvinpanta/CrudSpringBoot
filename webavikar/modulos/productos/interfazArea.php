            ...
            foreach ($datos as $key => $value) {
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        ...
                        onclick="
                            xajax__InterfazAreaFormulario(\''.$value['area'].'\');
                            ...
                            Swal.fire({
                              ...
                              confirmButtonText: \'Si, Eliminar registro!\'
                                  ...
                                  if (result.isConfirmed) {
                                      xajax__InterfazAreaMantenimiento(\'3\',\''.$value['area'].'\')
                                  }
                            })
                    ...
                    <div class="modal-body">
                        <form id="formarea" name="formarea" onSubmit="return false" onkeypress="if(gKeyEnter(event)) return false;">
                            ...
                            <div class="well-login">
                                ...
                                <input type="hidden" id="id" name="id" value="'.$area.'">
...
function _InterfazAreaPrincipal() {

    $rpta = new xajaxResponse('UTF-8');

    $objIn = new InterfazArea();
...
function _InterfazAreaFormulario($area = ''){

    $rpta = new xajaxResponse('UTF-8');

    $objIn = new InterfazArea();
    $rpta->addAssign("ajaxFormulario", "innerHTML", $objIn->formularioarea($area));
...
function _InterfazAreaMantenimiento($xFlag, $xForm){
...
$xajax->registerFunction("_InterfazAreaPrincipal");
$xajax->registerFunction("_InterfazAreaListado");
$xajax->registerFunction("_InterfazAreaFormulario");
$xajax->registerFunction("_InterfazAreaMantenimiento");
